...
interface PageHeaderProps {
  title: string;
  /** If provided, renders an arrow back button linking to this href */
  backHref?: string;
  /** Optional right-side action (e.g. a Create button) */
  action?: React.ReactNode;
}

/**
 * Uniform page header used across all screens.
 *
 * Structure: [back arrow?] [Title flex-1] [action?] [NavMenu]
 */
