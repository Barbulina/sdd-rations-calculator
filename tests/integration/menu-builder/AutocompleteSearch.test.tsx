...
describe('AutocompleteSearch', () => {
  let onSelectAliment: ReturnType<typeof vi.fn<[(aliment: UnifiedAliment) => void]>>;
  ...
  describe('keyboard navigation', () => {
    it('should highlight first item on ArrowDown', async () => {
      ...
      const firstOption = screen.getByText('Manzana Golden').closest('[role="option"]');
    ...
    it('should move down on multiple ArrowDown presses', async () => {
      ...
      const secondOption = screen.getByText('Plátano').closest('[role="option"]');
    ...
    it('should wrap to last item on ArrowUp from first', async () => {
      ...
      const lastOption = screen.getByText('Pan integral').closest('[role="option"]');
  ...
  describe('click to select', () => {
    ...
    it('should clear search input after selection', async () => {
      ...
      const searchInput = screen.getByPlaceholderText(/buscar alimento/i) as HTMLInputElement;
      await userEvent.type(searchInput, 'manzana');
  ...
  describe('empty state', () => {
    ...
    it('should not show empty state when results exist', async () => {
      ...
      expect(screen.queryByText(/no se encontraron alimentos/i)).not.toBeInTheDocument();
    });
