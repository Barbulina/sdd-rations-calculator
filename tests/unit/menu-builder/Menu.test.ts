...
import { MenuItemBuilder,  createMenuItem, createTestAliment } from './MenuItemBuilder';
...
describe('Menu', () => {
  describe('creation', () => {
    it('should create Menu with valid data', () => {
      ...
      expect(menu.id).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
  ...
  describe('name validation', () => {
    it('should reject empty name after trimming', () => {
      ...
      expect(() => new Menu('', 'frutas', items)).toThrow('Menu name is required');
    });
    ...
    it('should reject name exceeding 200 characters', () => {
      ...
      expect(() => new Menu(longName, 'frutas', items)).toThrow('Menu name must not exceed 200 characters');
    });
  ...
  describe('type validation', () => {
    ...
    it('should reject invalid type', () => {
      ...
      expect(() => new Menu('Test', 'invalid-type', items)).toThrow('Invalid menu type');
    });
  ...
  describe('items validation', () => {
    it('should reject empty items array', () => {
      expect(() => new Menu('Test Menu', 'frutas', [])).toThrow('Menu must contain at least one aliment');
    });
